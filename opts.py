...
parser.add_argument('dataset', type=str, choices=['hmdb_ucf', 'hmdb_ucf_small', 'ucf_plympic', 'something' ])
parser.add_argument('modality', type=str, choices=['RGB', 'Flow'])

parser.add_argument('--train_source_list', type=str, default="")
parser.add_argument('--train_target_list', type=str, default="")

#parser.add_argument('--train_list', type=str,default="")

parser.add_argument('--val_list', type=str, default="")
#parser.add_argument('--root_path', type=str, default="")
parser.add_argument('--root_path_source', type=str, default="")
parser.add_argument('--root_path_target', type=str, default="")
